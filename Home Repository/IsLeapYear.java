        ...
        try {
            do {
                ...
                if (inputYear < GREG_ADOPT) {
                    System.err.println("Invalid input. Please enter a year "
                    + "after the Gregorian Calendar was introduced (1582).");
                } else if (inputYear % NOT_DIV_HUNDRED != REMAINDER && inputYear % DIV_FOUR == REMAINDER || inputYear % DIV_FOUR_HUNDRED == REMAINDER) {
